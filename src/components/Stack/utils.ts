...
export const objectKeys = (obj: Record<string, any>) => Object.keys(obj);
...
export function mapResponsive(prop: any, mapper: (value: any) => any) {
  if (isArray(prop)) {
...
export function getStackStyles(options: Record<string, any>) {
...
export function getDividerStyles(options: Record<string, any>) {
  const { spacing, direction } = options;
